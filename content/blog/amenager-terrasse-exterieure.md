...
Un eclairage extérieur indirect (guirlandes LED, bornes basses, lampes solaires) transformé l'usage de la terrasse. Comptez 3 points lumineux minimum pour 15 m2 : un pour la table, un pour le coin detente, un pour les plantes.
